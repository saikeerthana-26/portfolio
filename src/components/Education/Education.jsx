      ...
      <div className="relative">
        ...
        {education.map((edu, index) => (
          ...
          >
            {/* Content Section */}
            <div
              className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl shadow-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(20,184,166,0.3)] ${index % 2 === 0 ? "sm:ml-0" : "sm:mr-0"
